...
use blocapp\modules\admin\Forms\formsections;
...
* editecole
**/
public function consulterecole(){
        $Vue=new View();
        ...
        if(!empty($idecole)
            ...
            $Vue->liste= $Rececole_Row ? $Rececole_Row : array();
            $datas=array(
                            "idecole"=>\lib\Langue::getString("idecole") 
,
            "nomecolear"=>\lib\Langue::getString("nomecolear") 
,
            "idcentraleregional"=>\lib\Langue::getString("idcentraleregional") 
,
            "nomecolefr"=>\lib\Langue::getString("nomecolefr") 
,
            "adressecolear"=>\lib\Langue::getString("adressecolear") 
,
            "adressecolefr"=>\lib\Langue::getString("adressecolefr") 
,
            "autreinfo"=>\lib\Langue::getString("autreinfo") 
...
* editniveaux
**/
public function consulterniveaux(){
        $Vue=new View();
        ...
        if(!empty($idniveaux)
            ...
            $Vue->liste= $Recniveaux_Row ? $Recniveaux_Row : array();
            $datas=array(
                            "idniveaux"=>\lib\Langue::getString("idniveaux") 
,
            "nomarniveau"=>\lib\Langue::getString("nomarniveau") 
,
            "idsections"=>\lib\Langue::getString("idsections") 
,
            "idecole"=>\lib\Langue::getString("idecole") 
,
            "nomfrniveau"=>\lib\Langue::getString("nomfrniveau") 
,
            "level"=>\lib\Langue::getString("level") 
,
            "descniveau"=>\lib\Langue::getString("descniveau") 
...
public function gestionniveaux(){
$Vue=new View();
$Vue->generate();
}
...
* editsections
**/
public function consultersections(){
        $Vue=new View();
        ...
        if(!empty($idsections)
            ...
            $Vue->liste= $Recsections_Row ? $Recsections_Row : array();
            $datas=array(
                            "idsections"=>\lib\Langue::getString("idsections") 
,
            "nomsectionar"=>\lib\Langue::getString("nomsectionar") 
,
            "nomsectionfr"=>\lib\Langue::getString("nomsectionfr") 
,
            "descsection"=>\lib\Langue::getString("descsection") 
...
public function gestionsections(){
$Vue=new View();
$Vue->generate();
}
